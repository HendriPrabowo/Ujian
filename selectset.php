...
<label>No Duduk
<span class="small">Otomatis <a rel="facebox" href="seatlocation.php?id=<?php echo $busnum; ?>">Lihat Kursi</a></span>
</label>
...
" id="name" readonly/><br>
<label>Nama Depan
<span class="small">Masukan Nama Depan</span>
</label>
<input type="text" name="fname"  id="name"/><br>
<label>Nama Akhir
<span class="small">Masukan Nama Akhir</span>
</label>
<input type="text" name="lname"  id="name"/><br>
<label>Alamat
<span class="small">Masukan Alamat</span>
</label>
<input type="text" name="address"  id="name"/><br>
<label>Kontak
<span class="small">Masukan Nomor Kontak</span>
</label>
