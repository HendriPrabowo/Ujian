		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
				...
				<div id="content" class="clearfix">
					...
					<a rel="facebox" href="addroute.php">TambahJurusan</a>
					
					<table cellpadding="1" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th  style="border-left: 1px solid #C1DAD7"> TipeBus </th>
								<th> Jurusan </th>
								<th> JumlahKursi </th>
								<th> Harga </th>
								<th> Waktu </th>
							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="center"><a rel="facebox" href="editrutedetails.php?id='.$row['id'].'">Ubah</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">Hapus</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
