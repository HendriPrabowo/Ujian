...
<title>Sistem Pemesanan Tiket Bus Budiman</title>
...
<div id="wrapper">
    ...
    <h1><a href="index.php"></a></h1>
        <ul id="mainnav">
            ...
            <li><a href="routes.php">Jurusan</a></li>
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    ...
                    <li><img src="xres/images/jb2/01.jpg" width="861" height="379"  alt="" /></li>
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<h2 class="accordion-header" style="height: 18px; margin-bottom: 15px; color: rgb(255, 255, 255); background: none repeat scroll 0px 0px rgb(53, 48, 48);">Pesan Tiket</h2>
					<div class="accordion-content" style="margin-bottom: 15px;">
						<form action="selectset.php" method="post" style="margin-bottom:none;">
						<span style="margin-right: 11px;">Pilih Jurusan: 
						...
						<span style="margin-right: 11px;">Jumlah Penumpang: 
						...
						<input type="submit" id="submit" value="Lanjut" style="height: 34px; margin-left: 15px; width: 191px; padding: 5px; border: 3px double rgb(204, 204, 204);" />
						</form>
					</div>
					<h2 class="accordion-header" style="height: 18px; margin-bottom: 15px; color: rgb(255, 255, 255); background: none repeat scroll 0px 0px rgb(53, 48, 48);">Masuk Admin</h2>
					<div class="accordion-content" style="margin-bottom: 15px;">
						...
						<input type="submit" id="submit" class="medium gray button" value="Masuk" style="height: 34px; margin-left: 15px; width: 191px; padding: 5px; border: 3px double rgb(204, 204, 204);" />
						</form>
					</div>
				</div>
        </div>
    ...
    <div id="featured">
        <div id="items">
            <div class="item"> <a href="main-course.php"><img src="xres/images/03.jpg" alt="" /></a>
            <h3><a href="main-course.php">Armada Baru</a></h3>
            <p><a href="#"><strong>Best In Class</strong><br />
			Rasakan Kenyamanannya!! <br /> Armada
			Bus Baru Kami<br /> Spesial Mudik!</a></p>  
            </div>
            <div class="item"> <a href="lodging.php"><img src="xres/images/02.jpg" alt="" /></a>
            <h3><a href="lodging.php">Jurusan Baru</a></h3>
            <p><a href="lodging.php"><strong>Dari Bandung Ke Padang</strong><br />
			Pemberhentian Di Restoran & Rest Area SNI </a></p>  
			</div>
	...
	<div id="footer">
	<h4>+62 89682250905 &bull; <a href="contact-us.php">Jl.Soekarno Hatta, Cibiru, Bandung </a></h4>
	<p>Hours of Operation&nbsp;&nbsp;&bull;&nbsp;&nbsp;Senin - Minggu: 08:00 - 20:00 </p>
	<a href="index.php"><img src="xres/images/footer-logo.jpg" alt="James Buchanan Pub and Restaurant" /></a>
	<p>&copy; Copyright 2015 Bus Budiman | All Rights Reserved <br /></p>
</div>
</div>
</body>
</html>
